...
public class Enemy : MonoBehaviour
{
    ...
    void Update(){
        ...
        if (timer > lastAttackTime + attackCd / attackSpeed * 100 && (type == 1 || type == 101 || type == 2)){
...
else if (type == 2)
{
    isAttacking = true;
    anim.SetTrigger("Attack");
    yield return new WaitForSeconds(0.3f); // 공격 모션 대기
     // 플레이어 방향 계산
    Transform player = GameManager.instance.player.transform;
